...
async def twilio_media_socket(websocket: WebSocket) -> None:
    ...
    stt_model = get_env("SARVAM_STT_MODEL", "saaras:v3")
    ...
    tts_stream_chunk_chars = int(get_env("TTS_STREAM_CHUNK_CHARS", "24"))
    tts_stream_flush_punct = get_env_bool("TTS_STREAM_FLUSH_PUNCT", True)
    tts_min_buffer_size = int(get_env("TTS_MIN_BUFFER_SIZE", "18"))
    tts_max_chunk_length = int(get_env("TTS_MAX_CHUNK_LENGTH", "96"))
