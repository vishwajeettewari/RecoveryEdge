...
describe("OverviewPage", () => {
  it("renders the operations overview sections", async () => {
    renderPage();

    await waitFor(() => {
      expect(screen.getByText("Early Bucket Control Room")).toBeInTheDocument();
      expect(screen.getByText("Demo Story")).toBeInTheDocument();
      expect(screen.getByText("PTP Discipline Engine")).toBeInTheDocument();
      expect(screen.getByText("Roll-Forward Heatmap")).toBeInTheDocument();
